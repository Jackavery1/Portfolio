...
describe('CONFIGURATION', () => {
  ...
  it('expose les sections attendues', () => {
    ...
    expect(CONFIGURATION.BONUS_SCORE.PAGE).toBe(400);
    expect(CONFIGURATION.BONUS_SCORE.PROJET).toBe(1200);
    expect(CONFIGURATION.BONUS_SCORE.BOSS_DOJO).toBe(600);
    expect(CONFIGURATION.BONUS_SCORE.BOSS_DOJO_VAINCU).toBe(900);
